...
SECRET_KEY = 'django-insecure--ppu)8*w=!g4o2##z1)d1ko6iy*8@-kc+*egu*c0b(soopitdg'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        ...
        "rest_framework.authentication.SessionAuthentication",  # убирает в DRF Authentication
    ],
